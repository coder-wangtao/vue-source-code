...
export function reactive(target: object) {
  ...
  //mutableCollectionHandlers：对集合类型的处理器 Map/set
  //reactiveMap，用来存放target到响应式对象的映射关系
...
function createReactiveObject(
  ...
  //proxyMap已经存在了target对应的proxy对象，那么直接返回即可
  ...
  //创建target对象对应的Proxy对象，并传入basebaseHandlers
  ...
  //用一个weakMap保存target 和 他对应的proxy
